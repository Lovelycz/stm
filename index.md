...
- 参与车辆的数据采集主控板开发，包括元器件选型、PCB设计及焊接、完成硬件调试，并解决一代数据采集主控板存在的不足，实现对车辆的电压电流等数据采集。
...
- 通过VR设备与系统构建的场景进行交互和反馈。作为开发组成员，熟悉系统设计原理，嵌入式系统落地后收集用户反馈，与开发团队沟通，协作修复软件缺陷，促进系统的升级。
